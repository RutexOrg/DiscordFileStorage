...
Windows explorer will support webdav out of the box. You can now [add windows network drive](https://www.maketecheasier.com/map-webdav-drive-windows10/) to http://localhost:3000/dav (\\localhost@3000\dav) and use DICloud as a regular drive.
